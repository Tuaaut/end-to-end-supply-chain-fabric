...
try:
    ...
    slv_inventory_snapshot = (
        ...
        .withColumn(
            ...
            .when(F.col("reserved_qty").isNull() | (F.col("reserved_qty") < 0), "INVALID_RESERVED_QTY")
